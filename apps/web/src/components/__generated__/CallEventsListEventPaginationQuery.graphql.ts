...
export type CallEventsListEventPaginationQuery$variables = {
  cursor?: string | null;
  first?: number | null;
  id: string;
};
export type CallEventsListEventPaginationQuery$data = {
  readonly node: {
    readonly " $fragmentSpreads": FragmentRefs<"CallEventsListQuery_call">;
  } | null;
};
export type CallEventsListEventPaginationQuery = {
  response: CallEventsListEventPaginationQuery$data;
  variables: CallEventsListEventPaginationQuery$variables;
};
